...
\tightlist
\item
  Our \href{https://github.com/nhejazi/medoutcon}{\passthrough{\lstinline!medoutcon!} \passthrough{\lstinline!R!} package}, which
  accompanies \citet{diaz2020nonparametric}, implements one-step and TML estimators of
...
\item
  ...
  Lasso (\(\ell_1\)-penalized) regression, and random forests (\passthrough{\lstinline!ranger!}).
\end{itemize}
...
\item
  Now, we're ready to use the \passthrough{\lstinline!medoutcon!} function to estimate the \emph{natural
  direct effect}:
\end{itemize}
...
\tightlist
\item
  We can similarly call the \passthrough{\lstinline!medoutcon!} function to estimate the \emph{natural
  indirect effect}:
\end{itemize}
...
\item
  Now, we're ready to use the \passthrough{\lstinline!medoutcon!} function to estimate the
  \emph{interventional direct effect}:
\end{itemize}
...
\tightlist
\item
  We can similarly call the \passthrough{\lstinline!medoutcon!} function to estimate the
  \emph{interventional indirect effect}:
\end{itemize}
