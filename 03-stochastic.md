...
<!--KER this next bullet does not make sense to me-->
...
<!--
ID: Should I add: continuous interventions, and/or the definitions of effects
with intermediate confounders?

KER: I don't think adding for intermediate confounders is necessary. Continuous
interventions would be really useful *if* practical methods existed for that,
but I think despite the paper existing, it hasn't really been done in practice,
right? So probably wouldn't want to get into that.
-->
