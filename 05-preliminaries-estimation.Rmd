...
1. _one step_ estimator:
  \begin{equation*}
    \psi(\hat \P) + \frac{1}{n}\sum_{i=1}^n D(O;\hat \P_i)
  \end{equation*}
- Idea: subtract an estimate of the
  bias of the g-computation estimator
2. _targeted maximum likelihood estimator_ (TMLE)
- TMLE is based on the principle that it is possible to construct a
