...
- Let's perform a simulation where we draw 1000 datasets from the above distribition, and compute a g-computation estimator based on
```{r, echo = TRUE, eval = FALSE}
...
<!--
KER: I don't find the below helpful
-->
