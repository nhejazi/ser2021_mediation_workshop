...
If the cross-world assumption holds (defined below), the NDE can also be written as: $\E_W \sum_m \{\E(Y_{1,m} \mid W) -
...
$$ \E(Y_{1,M_0} - Y_{0,M_0}) = \E_w\{\sum_m\[\E(Y \mid 1, m, w) - \E(Y \mid 0, m, w)\]P(M=m | A=0,w)\}$$
...
$$ \E(Y_{1, g_{M \mid 0, W}}) -
   \E(Y_{0, g_{M \mid 0, W}}) = \E_w \{ \sum_{z,m} \[\E(Y | 1, z, m, w)P(z | 1, w) - \E(Y | 1, z, m, w)P(z | 0, w)\] P(m | A=0, w) \} $$
