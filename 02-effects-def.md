...
<!--
ID: I don't follow this discussion about marginal vs conditional
What you call the conditional effects are not really direct effects as they do not consider the pathway A>Z>M>Y
I would completely omit that discussion 
-->
...
\]
<!--
ID: We should probably spend a good chunk of time going through these identification formulas and teaching people what they mean algorithmically
For example, we could have a step by step R code chunck here where we implement a g-computation estimator for them... this would go a long way in building intuition i think
-->
### Identification assumptions:
