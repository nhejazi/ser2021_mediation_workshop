...
```{r, engine="tikz", fig.cap = "Directed acylcic graph under _no intermediate confounders_ of the mediator-outcome relation affected by treatment", fig.ext = "pdf", echo = FALSE}
