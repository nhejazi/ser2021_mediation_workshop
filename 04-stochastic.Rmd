...
- Consider the effect of participation in a sports team on children's BMI
- Mediation through behavioral covariates such as snacking, exercising, etc.
- Intervention: for each individual, increase the odds of participating in a sports team by $\delta=2$
