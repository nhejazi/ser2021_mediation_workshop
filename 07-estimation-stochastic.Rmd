...
```{r make_sl1, message=FALSE, warning=FALSE, eval=FALSE}
...
```{r efficient_est, message=FALSE, warning=FALSE, eval=FALSE}
...
```{r make_sl2, message=FALSE, warning=FALSE}
...
```{r de_os, message=FALSE, warning=FALSE, eval=FALSE}
...
```{r de_tmle, message=FALSE, warning=FALSE, eval=FALSE}
...
```{r ie_os, message=FALSE, warning=FALSE, eval=FALSE}
...
```{r ie_tmle, message=FALSE, warning=FALSE, eval=FALSE}
